...
Асинхронная модель JavaScript и механизмы выполнения кода.  
Материал представлен в формате **вопрос–ответ**.

1. [Что такое Promise](#1-что-такое-promise)
2. [Состояния Promise](#2-состояния-promise)
3. [Цепочки `.then`](#3-цепочки-then)
4. [Способы обработки ошибок в Promise](#4-способы-обработки-ошибок-в-promise)
5. [`Promise.all`, `Promise.race`, `Promise.allSettled`, `Promise.any`](#5-promiseall-promiserace-promiseallsettled-promiseany)
6. [Что происходит, если Promise в `Promise.all` отклоняется](#6-что-происходит-если-promise-в-promiseall-отклоняется)
7. [Что такое `async / await`](#7-что-такое-async--await)
8. [Что возвращает `async` функция](#8-что-возвращает-async-функция)
9. [Можно ли использовать `await` вне `async`](#9-можно-ли-использовать-await-вне-async)
10. [Что такое Event Loop и зачем он нужен](#10-что-такое-event-loop-и-зачем-он-нужен)
11. [Call Stack](#11-call-stack)
12. [Microtasks и Macrotasks](#12-microtasks-и-macrotasks)
13. [Порядок выполнения `async / await`](#13-порядок-выполнения-async--await)
14. [Когда реально выполняется `setTimeout`](#14-когда-реально-выполняется-settimeout)
15. [Порядок выполнения `Promise`, `setTimeout`, `async / await`](#15-порядок-выполнения-promise-settimeout-async--await)
...
## 4. Способы обработки ошибок в Promise
...
## 6. Что происходит, если Promise в `Promise.all` отклоняется
...
## 8. Что возвращает `async` функция
...
## 9. Можно ли использовать `await` вне `async`
...
## 10. Что такое Event Loop и зачем он нужен
...
## 13. Порядок выполнения `async / await`
...
## 14. Когда реально выполняется `setTimeout`
...
## 15. Порядок выполнения `Promise`, `setTimeout`, `async / await`
