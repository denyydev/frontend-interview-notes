...
Фундаментальные концепции JavaScript и особенности поведения языка.
Материал оформлен в формате вопросов и ответов.
...
15. [Ключевые отличия ES5 и ES6+](#15-ключевые-отличия-es5-и-es6)
...
if (value == null) {
} // допустимо (проверяет и null, и undefined)
...
[1] +
  ...
  [3, 4][10] - // [1,2] → "1,2", [3,4] → "3,4" // "1,23,4"
  [5][10] * // 5 (при - массивы → числа)
    [5]; // 50
```
